...
@Override
    public void displayMenu() {
        ...
        System.out.println("13 - View all members (database)");
        System.out.println("14 - Update member (database)");
        System.out.println("15 - Delete member (database)");
        System.out.println("16 - Search member by name (database)");
        System.out.println("17 - Search member by age range (database)");
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case 15:
                    ...
                    break;
                case 16:
                    searchMemberByNameDB();
                    break;
                case 17:
                    searchMemberByAgeRangeDB();
                    break;
                case 0:
                    System.out.println("\nGoodbye! ");
                    running = false;
